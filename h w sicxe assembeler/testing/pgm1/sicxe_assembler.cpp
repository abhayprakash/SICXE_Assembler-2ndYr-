...
/************************** printing intermediate file ******************************************/
    ofstream fileout("intermediate.txt");
    for(int i=0;i<rec_count;i++)
      fileout<<setw(4)<<setfill('0')<<hex<<record[i].Loc<<"\t"<<record[i].Label<<"\t"<<record[i].Operator<<"\t"<<record[i].Operand<<endl;
...
/*************************************** Pass 2 from here ***************************************/
    ...
    int b_val=0x1c;//this value of b will be stored in register B during execution but here i am putting it manually
    ...
    /*if(record[i].Operator=="LDB")
    {
        b_val=record[search_symtab(record[i].Operand.substr(1),symtab_count)].Loc;
    }*/
  }
    cout<<"\nPass 2 Completed.";
